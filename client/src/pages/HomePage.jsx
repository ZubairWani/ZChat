      ...
      `}>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
          ...
          `}>
            ...
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-300 leading-relaxed max-w-lg mx-auto">
                Securely connect with Zubair. Enter the unique secret key he shared with you to begin a private, encrypted chat.
              </p>
            </div>
          ...
          <div className="mt-8 sm:mt-12 text-center text-gray-500 text-xs sm:text-sm">
            <p>© 2025 ZChat. Secure. Private. Professional.</p>
          </div>
        </div>
      </div>
    </div>
